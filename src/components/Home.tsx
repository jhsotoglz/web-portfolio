  ...
  return (
    ...
    >
      <div className="global-content text-center animate-fade-in-up">
        <h1 className="text-4xl sm:text-5xl font-bold text-white">Welcome to my portfolio</h1>
        ...
        <a
          href="#projects"
          className="mt-8 inline-block px-6 py-3 text-white bg-extra rounded-2xl shadow hover:bg-secondary transition"
        >
          View My Work
        </a>
      </div>
